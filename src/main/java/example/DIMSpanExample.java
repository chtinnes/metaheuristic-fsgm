...
public class DIMSpanExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TLFDataSource dataSource = new TLFDataSource("file:///home/schwinnez/projects/OneIoT/fsgm/src/main/resources/model_graph_sorted.diffgraph", GradoopFlinkConfig.createConfig(env));
        // load data
        ...
        GraphCollection frequentSubgraphs = input
                .callForCollection(new TransactionalFSM(1f));
